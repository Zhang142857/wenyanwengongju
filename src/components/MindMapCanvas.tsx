...
export default function MindMapCanvas({ data, onNodeMove, onNodeClick, onNodeDoubleClick, onExportPNG }: MindMapCanvasProps) {
...
function NodeComponent({
  ...
  return (
    <div
      ...
      title={node.type === 'collapse' ? '点击展开更多例句' : undefined}
    >
